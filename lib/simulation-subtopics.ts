...
export const DAY_SUBTOPICS: Record<number, SubtopicData[]> = {
  ...
  11: [
    {
      id: 'evidence-summary',
      title: 'Pre-Conversation Evidence & Appraisal Review',
      badge: 'Data-Driven HR',
      overview: 'Reviewing contemporaneous performance records, probation confirmation notes, and 360° feedback before conducting a career conversation, ensuring HR enters prepared rather than uninformed.',
      legalBasis: 'CIPD Profession Map (People Practice). Grounding career development dialogues in verified performance evidence maintains credibility and procedural equity.',
      bestPractices: [
        'Cross-reference probation review notes with appraisal development targets.',
        'Identify specific technical milestones (e.g. 100% SLA uptime cutovers) to celebrate.',
        'Review colleague and supervisor feedback to identify leadership readiness.',
      ],
      pitfalls: [
        'Walking into a career dialogue without reviewing historical performance records.',
        'Confusing career development conversations with punitive performance improvement plans.',
      ],
      question: {
        question: 'Why must an HR specialist review appraisal and probation records before holding a career development conversation?',
        options: [
          'To ground the discussion in actual documented strengths and verified training gaps, rather than entering uninformed.',
          'To calculate how much to decrease the employee salary.',
          'To prepare an immediate dismissal notice.',
          'To avoid speaking to the employee line manager.',
        ],
        correctIndex: 0,
        explanation: 'Entering with documented evidence enables targeted, realistic development planning aligned with the employee actual track record.',
      },
    },
    {
      id: 'career-conversation',
      title: 'Live 1-on-1 Career Exploration Dialogue',
      badge: 'Voice Practicum',
      overview: 'Conducting an interactive career conversation with Jordan Hayes, exploring career aspirations, certification interests (DWDM/optical architecture), and potential next steps.',
      legalBasis: 'CIPD Profession Map (Talent Management & Internal Mobility). Proactive career development dialogues increase employee retention and build internal talent pipelines.',
      bestPractices: [
        'Listen actively to employee intrinsic interests rather than imposing a pre-baked corporate path.',
        'Explore lateral skill development alongside vertical promotional aspirations.',
        'Discuss concrete timelines and required milestone achievements.',
      ],
      pitfalls: [
        'Making unilateral verbal promotion promises that bypass formal vacancy governance.',
        'Dismissing technical certification ambitions as unnecessary overhead.',
      ],
      question: {
        question: 'What is the primary objective of a career conversation with a high-performing employee?',
        options: [
          'To understand their long-term aspirations, identify real development needs, and build a concrete retention roadmap.',
          'To promise an immediate unbudgeted promotion without managerial signoff.',
          'To convince them to never leave the company.',
          'To transfer all managerial duties to the employee.',
        ],
        correctIndex: 0,
        explanation: 'Effective career dialogues build mutual alignment between personal aspirations and organizational talent capability.',
      },
    },
    {
      id: 'career-plan',
      title: 'Formal Career Development Plan (CDP) Formulation',
      badge: 'Talent Architecture',
      overview: 'Documenting specific career goals, observable competencies to develop, structured training interventions, and a concrete next role target selected from the organizational chart.',
      legalBasis: 'Equality Act 2010 (Equal Opportunity in Progression). Formalizing development plans ensures fair, transparent access to career advancement across all employees.',
      bestPractices: [
        'Ensure skills to develop are specific, measurable, and non-generic (avoiding vague phrases like "wants to grow").',
        'Map next role targets to real existing positions in the company org chart (e.g. Senior Field Engineer).',
        'Set defined 6 to 18 month review milestones.',
      ],
      pitfalls: [
        'Writing generic aspirational fluff that cannot be tracked or measured.',
        'Naming fictitious next roles that have no budgetary or structural reality in the organization.',
      ],
      question: {
        question: 'Which of the following represents a high-quality, actionable skill development entry in a Career Plan?',
        options: [
          'Needs advanced DWDM optical splicing certification, high-density OTDR diagnostics, and junior field technician mentoring experience.',
          'Employee wants to grow and improve skills.',
          'Work harder and do better in upcoming quarters.',
          'Be enthusiastic about telecom networks.',
        ],
        correctIndex: 0,
        explanation: 'Concrete skill specifications name the exact certification, technical tool, and behavioral capability required for growth.',
      },
    },
    {
      id: 'recognition-prompt',
      title: 'Evidence-Based Recognition & Total Reward',
      badge: 'Total Reward',
      overview: 'Evaluating whether the employee has earned formal recognition (Employee of the Month, Certificate, Special Milestone) and documenting empirical justification based on appraisal outcomes.',
      legalBasis: 'Total Reward Strategy & Equity Principles. Recognition tied to verifiable milestones reinforces psychological engagement and procedural justice.',
      bestPractices: [
        'Cite specific documented milestones (e.g. H1 2026 Shoreditch cutover 100% SLA) in the justification note.',
        'Combine non-financial peer appreciation with formal company accolades.',
        'Ensure recognition criteria are applied consistently and transparently across teams.',
      ],
      pitfalls: [
        'Distributing awards based on favoritism or informal popularity rather than evidence.',
        'Issuing generic recognition notes that do not cite verifiable performance data.',
      ],
      question: {
        question: 'Why must formal employee recognition be tied to specific documented evidence?',
        options: [
          'It preserves the perceived fairness and motivational value of the award for all employees.',
          'It legally exempts the award from company accounting audits.',
          'It eliminates the need for future performance appraisals.',
          'It prevents employees from asking for leave.',
        ],
        correctIndex: 0,
        explanation: 'Evidence-backed recognition reinforces meritocracy and signals to the entire organization exactly what behaviors and outcomes are valued.',
      },
    },
  ],
  ...
  12: [
    {
      id: 'exit-case-selector',
      title: 'Active Separation Case & Resignation Dossier',
      badge: 'Offboarding Governance',
      overview: 'Reviewing the formal resignation case for Elena Rostova (Network Systems Specialist, 2.5 years tenure, relocating to Frankfurt), separated from the disciplinary case.',
      legalBasis: 'Employment Rights Act 1996 & Contractual Notice Provisions. Clear documentation of resignation notice ensures proper calculation of terminal payments and notice periods.',
      bestPractices: [
        'Confirm written receipt of the resignation letter and formal effective termination date.',
        'Calculate statutory notice period alignment with contractual terms.',
        'Initiate the knowledge handover protocol immediately.',
      ],
      pitfalls: [
        'Treating voluntary resignations with administrative neglect or hostility.',
        'Failing to record the official notice date in the master HRIS.',
      ],
      question: {
        question: 'Why is it critical to formalize written receipt of an employee resignation notice immediately?',
        options: [
          'To establish the legally binding contractual termination date, notice period, and final payroll cutoff.',
          'To immediately lock the employee out of the building without notice.',
          'To withhold all earned wages.',
          'To prevent the employee from obtaining a reference.',
        ],
        correctIndex: 0,
        explanation: 'Formalizing notice dates establishes clear statutory timelines for final salary, accrued leave payouts, and handover milestones.',
      },
    },
    {
      id: 'exit-checklist',
      title: 'Statutory Exit & Handover Governance Checklist',
      badge: 'Asset & IP Security',
      overview: 'Executing the 4 non-negotiable exit governance pillars: Notice verification, detailed knowledge handover documentation, company property return, and final payroll authorization.',
      legalBasis: 'Data Protection Act 2018 / ISO 27001 & Employment Rights Act 1996 (Section 13: Protection of Wages). Safeguarding company assets, IP, and terminal pay calculations.',
      bestPractices: [
        'Require minimum 30 characters of detailed operational handover documentation.',
        'Collect and log company hardware, security passes, VPN tokens, and diagnostic kits.',
        'Calculate accrued unused statutory annual leave days for final payroll payout.',
      ],
      pitfalls: [
        'Allowing employees to depart with unrevoked system administrator credentials.',
        'Miscalculating accrued holiday pay deductions or payouts.',
      ],
      question: {
        question: 'Under UK employment law, what happens to an employee accrued unused statutory annual leave upon resignation?',
        options: [
          'The employer must calculate and pay out the accrued unused statutory leave in the final payroll.',
          'The leave is automatically forfeited with zero compensation.',
          'The employee must transfer the leave to their next employer.',
          'The leave is converted into unpaid overtime.',
        ],
        correctIndex: 0,
        explanation: 'Under the Working Time Regulations 1998, workers are legally entitled to a payment in lieu of untaken statutory holiday on termination.',
      },
    },
    {
      id: 'exit-interview',
      title: 'Structured Exit Diagnostics & Feedback Form',
      badge: 'Retention Analytics',
      overview: 'Conducting a structured 6-dimension exit consultation with departing employee Elena Rostova, capturing insights across departure reasons, positives, challenges, management feedback, and eNPS recommendation.',
      legalBasis: 'CIPD Profession Map (Employee Voice & Retention). Exit interviews provide critical intelligence to diagnose leadership bottlenecks and mitigate turnover.',
      bestPractices: [
        'Conduct the interview in a neutral, confidential atmosphere to encourage candor.',
        'Capture all 6 structured dimensions to enable longitudinal turnover analytics.',
        'Probe constructively into operational bottlenecks (e.g. on-call rota fatigue).',
      ],
      pitfalls: [
        'Treating the exit interview as an administrative box-ticking exercise.',
        'Becoming defensive when departing employees offer constructive organizational criticism.',
      ],
      question: {
        question: 'What is the greatest organizational value derived from structured exit interviews?',
        options: [
          'Uncovering unvarnished operational and leadership feedback that active staff might hesitate to share.',
          'Persuading the departing employee to sign a lower salary contract.',
          'Finding reasons to deny references.',
          'Replacing the annual performance review.',
        ],
        correctIndex: 0,
        explanation: 'Departing employees have high psychological safety to disclose systemic blockers, management friction, and tooling gaps.',
      },
    },
    {
      id: 'file-closure',
      title: '12-Day Master Employee File Audit',
      badge: 'Audit Governance',
      overview: 'Performing a comprehensive chronological audit of the storyline employee (Jordan Hayes) master file across all 12 days — verifying consistency from Day 1 JD to Day 11 Career Plan before closure.',
      legalBasis: 'GDPR / Data Protection Act 2018 (Principle of Accuracy & Accountability). Ensuring all HR records are complete, accurate, and lawfully retained.',
      bestPractices: [
        'Audit the complete file from Day 1 to Day 11 to verify narrative coherence.',
        'Confirm contemporaneous notes are attached for every selection, probation, and appraisal checkpoint.',
        'Ensure role-based access restrictions are enforced on the closed archive.',
      ],
      pitfalls: [
        'Skipping the file audit and proceeding directly to analytics summaries without checking data integrity.',
        'Leaving conflicting or incomplete records in the master HR file.',
      ],
      question: {
        question: 'Why is a full chronological file audit essential before closing an employee HR record?',
        options: [
          'To verify that the complete lifecycle is documented consistently and accurately as one defensible record.',
          'To delete all negative feedback from the record.',
          'To ensure the employee cannot access their own data under GDPR.',
          'To reduce the size of the computer hard drive.',
        ],
        correctIndex: 0,
        explanation: 'A file audit verifies that every decision throughout the employee lifecycle is substantiated with contemporaneous evidence and compliant with statutory governance.',
      },
    },
    {
      id: 'capstone-analytics',
      title: 'Capstone Workforce Analytics & Strategic Interpretation',
      badge: 'Capstone Final',
      overview: 'Synthesizing auto-computed workforce analytics (Time-to-Hire, Absenteeism Rate, Turnover Rate) into a qualitative strategic interpretation to close the entire 12-day practicum.',
      legalBasis: 'CIPD Profession Map (Evidence-Based Practice). Transforming raw HR metrics into actionable strategic insights that guide executive decision-making.',
      bestPractices: [
        'Interpret the numbers rather than merely restating the digits (minimum 40 characters).',
        'Connect absenteeism patterns back to empirical findings (e.g. transit disruptions vs disengagement).',
        'Submit the final capstone to complete the NovaLink HR simulation curriculum.',
      ],
      pitfalls: [
        'Submitting a summary that simply repeats the numbers without qualitative meaning.',
        'Failing to link analytics to actionable management recommendations.',
      ],
      question: {
        question: 'What distinguishes a strategic HR analytics interpretation from simple data reporting?',
        options: [
          'Strategic interpretation explains what the numbers mean for management decisions and future workforce policy.',
          'Strategic interpretation contains more mathematical formulas.',
          'Data reporting is only done by accountants.',
          'Strategic interpretation requires hiding negative metrics from leadership.',
        ],
        correctIndex: 0,
        explanation: 'Metrics alone are descriptive; professional HR analytics interprets the root causes behind the numbers and recommends proactive solutions.',
      },
    },
  ],
}
